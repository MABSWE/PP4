...
urlpatterns = [
    ...
    path('logout/', LogoutView.as_view(next_page='home'),
         name='logout'),  # Logout and redirect to home
    ...
    path('blog/', views.blog_view, name='blog'),
    path('article/<int:post_pk>/comment/<int:comment_pk>/edit/',
         views.edit_comment, name='edit_comment'),  # Edit Comments
    path('article/<int:post_pk>/comment/<int:comment_pk>/delete/',
         views.delete_comment, name='delete_comment'),  # Delete Comments
